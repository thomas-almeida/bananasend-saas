...
const DEFAULT_SEQUENCES: TypewriterSequence[] = [
  { text: "Para Agências", deleteAfter: false },
  { text: "Para Afilhados", deleteAfter: false },
  { text: "Para TIs", deleteAfter: false },
  { text: "Para RHs", deleteAfter: false },
  { text: "Para Ecommerces", deleteAfter: false },
  { text: "Pra Você!", deleteAfter: false }
];
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl py-2">
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        <motion.div
          animate={{ opacity: 1 }}
          className="flex items-center gap-1 font-mono text-md text-black tracking-tight md:text-md dark:text-white"
          initial={{ opacity: 0 }}
          transition={{ duration: 2.5 }}
        >
          <span className="inline-block min-h-[1.2em] min-w-[0.5em] italic">
            {displayText}
          </span>
          <motion.span
            animate={{
